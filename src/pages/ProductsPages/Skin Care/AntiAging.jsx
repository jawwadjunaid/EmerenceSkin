      ...
      <div>
        <div className="Container d-flex m-5 justify-content-center align-items-center ">
          ...
          <div className="productDetails" style={{ marginLeft: "80px" }}>
            ...
            <Typography>
              ⁃ Hydroxysomes Adenosine, Retinaldehyde, Resveratrol <br></br>⁃
              Matryxl with Hyaluronic Acid<br></br>⁃ Retinol with Hyaluronic
              Acid<br></br>⁃ Vitamin A, C, E and Hyaluronic Acid Cream and Serum
              <br></br>⁃ Lupine Extract and Pisum Sativum with Hyaluronic Acid
              Serum
            </Typography>
