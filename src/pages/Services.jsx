...
const Services = () => {
  ...
  <div className="position-relative p-0 m-0">
    ...
    <div className="position-absolute top-50 start-50 translate-middle text-center w-100">
         ...
         <h1 className="text-light ">Skin Care Manufacturing Total Solutions</h1>
        ...
        <div className="container mt-5 p-5">
          <div className="row">
            <div className="col-md-6">
              ...
              <ul>
                <li>Good formula and packaging are the foundation of the product. We focus on 
                  continuously creating value for customers. We care about every detail to ensure that your product can achieve good sales in the market.</li>
             </ul>
             <h2>Broadened Categories</h2>
                <ul><li>On the basis of good products, 
                  using the advantages of china's supply chain, ariel cosmetic will provide a full range of services for your products expansion plan.</li></ul>
              <h2>Brand Driven</h2>  
              <ul><li>With good formula & packaging and strict 
                quality control conditions, you can focus more on the growth of your brand and focus on longer-term growth to quickly drive your brand.</li></ul>
            ...
            <div className="col">
              <div className="card shadow p-3 mb-5 bg-body rounded">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    We understand that many customers do not have suitable space
                    to store their goods, and sometimes they temporarily need to
                    store their goods for the peak sales season.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="card shadow p-4 mb-5 bg-body rounded">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    professional consultation, Arielcosmetic hopes to solve your
