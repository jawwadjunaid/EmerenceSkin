      ...
      <div>
        <div className="Container d-flex m-5 justify-content-center align-items-center ">
          <div>
            <Carousel>
              ...
              <Carousel.Item>
                <img
                  loading="lazy"
                  srcSet="/Images/ProductImages/Toners/GrapeFriut.jpg"
                  className="d-block w-100"
                  alt="Slide 2"
                />
              </Carousel.Item>
              <Carousel.Item>
                <img
                  srcSet="/Images/ProductImages/Toners/GrapeSeedToner.jpg"
                  loading="lazy"
                  className="d-block w-100"
                  alt="Slide 2"
                />
              ...
              <Carousel.Item>
                <img
                  srcSet="/Images/ProductImages/Toners/TeaTree.jpg"
                  loading="lazy"
                  className="d-block w-100"
                  alt="Slide 2"
                />
          ...
          <div className="productDetails" style={{ marginLeft: "40px" }}>
            ...
            <Typography>
              ⁃ B3 and Hyaluronic Acid toner with Plant Extracts<br></br>⁃ AHA
              and BHA Toner<br></br>⁃ Grapefruit Extract Toner <br></br>Grape
              seed Extract and Sodium PCA Toner<br></br>Tea Tree Oil Toner
            </Typography>
