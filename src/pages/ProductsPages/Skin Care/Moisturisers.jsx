    ...
    <>
      ...
      <div>
        ...
        <div className="productDetails" style={{ marginLeft: "80px" }}>
          ...
          <Typography>
            ⁃ For Dry skin with Urea, Squalane, Peptides<br></br>⁃ For Oily skin, acne prone skin with Vitamin C, E and Niacinamide <br></br>⁃ Gel Moisturiser with Hyaluronic Acid 
          </Typography>
