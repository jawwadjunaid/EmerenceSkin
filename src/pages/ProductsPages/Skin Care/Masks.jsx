        ...
        <div className="Container d-flex m-5 justify-content-center align-items-center ">
          <div>
            <Carousel>
              <Carousel.Item>
                <img loading='lazy'
                  srcSet="/Images/ProductImages/Masks/AphaArbutin.jpg"
          ...
          <div className="productDetails" style={{ marginLeft: "80px" }}>
            ...
            <Typography>
              ⁃ Rejuvenating Frankincense Face Mask<br></br>⁃ Apha Arbutin and
              B3 for Skin Glow<br></br>⁃ Green Tea, Retinol and Jojoba Oil Mask
              for Mature Skin
            </Typography>
