    ...
    <>
      <div className="Container d-flex m-5 justify-content-center align-items-center ">
        ...
        <div className="productDetails" style={{ marginLeft: "80px" }}>
          ...
          <Typography>
            ⁃ Salicylic Acid for oily and acne prone skin<br></br>⁃ Mendelic
            acid and tea tree oil face wash<br></br>⁃ Vitamin C + Vitamin B3
            Face Wash<br></br>⁃ Glycolic Acid Face Wash
          </Typography>
