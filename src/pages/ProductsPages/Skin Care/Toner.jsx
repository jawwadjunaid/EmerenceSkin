...
<div className="Container d-flex m-5 justify-content-center align-items-center ">
        ...
        <div className="productDetails" style={{ marginLeft: "80px" }}>
          ...
          <Typography>
            ⁃ B3 and Hyaluronic Acid toner with Plant Extracts<br></br>⁃ AHA and BHA Toner<br></br>⁃ Grapefruit Extract Toner <br></br>Grape seed Extract and Sodium PCA Toner<br></br>Tea Tree Oil Toner 
          </Typography>
