        ...
        <div className="Container d-flex m-5 justify-content-center align-items-center ">
          <div>
            <Carousel>
              <Carousel.Item>
                <img loading='lazy'
                  srcSet="/Images/ProductImages/BodyButter/lavenderbody.jpg"
              ...
              <Carousel.Item>
                <img loading='lazy'
                  srcSet="/Images/ProductImages/BodyButter/tangerine.jpg"
                  className="d-block w-100"
                  alt="Slide 2"
                />
              </Carousel.Item>
          ...
          <div className="productDetails" style={{ marginLeft: "80px" }}>
            ...
            <Typography>
              ⁃ Lavender Body Butter<br></br>⁃ Tangerine and Orange Body Butter
            </Typography>
